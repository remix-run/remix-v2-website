...
const outlinePrimaryButtonLinkClass =
...
const primaryButtonLinkClass = `${baseButtonLinkClass} bg-blue-600 text-white hover:bg-blue-700 focus:ring-blue-200 transition-colors duration-200`;
